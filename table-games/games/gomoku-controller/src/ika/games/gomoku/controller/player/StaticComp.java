...
public class StaticComp implements GomokuPlayer {
    ...
    protected boolean condintion(int n, int i1, int j1, int i2, int j2, int t) {
            switch(n) {
                case 1 : return is(i1, j1, LMAX, t);
                case 2 : return (is(i1, j1, LMAX - 1, t) && list[x1][y1] == 0 && list[x2][y2] == 0 &&
                                (!is(i2, j2, LMAX - 1, 3 - t) || (list[x1][y1] > 0 && list[x2][y2] > 0))) ||
                                is(i1, j1, LMAX, t);
                case 4 : return is(i1, j1, LMAX - 1, t) && (list[x1][y1] == 0 || list[x2][y2] == 0);
                case 6 : return is(i1, j1, LMAX - 2, t) && list[x1][y1] == 0 && list[x2][y2] == 0;
                case 8 : return is(i1, j1, LMAX - 3, t) && list[x1][y1] == 0 && list[x2][y2] == 0 && x1 != x2;
                case 10 : return is(i1, j1, 2, t) && y1 == y2;
